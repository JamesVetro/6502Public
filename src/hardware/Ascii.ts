...
export class Ascii {
    ...
    constructor() {
        ...
        this._asciiTable = asciiChart.split(" ");
    }
    ...
    public hexToASCII(hex: number) {
        ...
        return this._asciiTable[dec];
        
    }

    // Converts from ASCII to hex
    public asciiToHex(ascii: string){
        for (let i = 0; i < this._asciiTable.length; i++) {
            if (this._asciiTable[i] == ascii) {
